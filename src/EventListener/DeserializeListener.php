...
use App\Provider\FormatsProviderInterface;
use JMS\Serializer\DeserializationContext;
use App\Serializer\SerializerContextBuilderInterface;
...
final class DeserializeListener
{
    ...
    public function onKernelRequest(GetResponseEvent $event)
    {
        ...
        $context = $this->serializerContextBuilder->createFromRequestAttributes(false, $attributes);
